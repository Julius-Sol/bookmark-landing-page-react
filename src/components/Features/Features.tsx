...
function Features() {
  return (
    ...
    <div className='features__slide-cont'>
      ...
      <div className="features__slide">
        ...
        <p className='features__slide__description'>Organize your bookmarks however you like. Our simple drag-and-drop interface gives you complete control over how you manage your favourite sites.
        </p>
